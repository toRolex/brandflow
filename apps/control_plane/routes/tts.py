...
PRESET_VOICES = [
    ...
    {"id": "苏打", "label": "苏打", "note": "中文男声，适合短视频口播", "model": "mimo-v2.5-tts"},
    {"id": "白桦", "label": "白桦", "note": "中文男声，稳重讲解", "model": "mimo-v2.5-tts"},
...
QWEN_VOICES = [
    ...
    {"id": "Kiki", "label": "阿清（粤语）", "note": "甜美的港妹闺蜜女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Cherry", "label": "芊悦", "note": "阳光积极、亲切自然女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Serena", "label": "苏瑶", "note": "温柔女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Ethan", "label": "晨煦", "note": "阳光温暖男声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Chelsie", "label": "千雪", "note": "二次元虚拟女友声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Momo", "label": "茉兔", "note": "撒娇搞怪女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Vivian", "label": "十三", "note": "拽拽可爱的女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Moon", "label": "月白", "note": "率性帅气男声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Maia", "label": "四月", "note": "知性温柔女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Kai", "label": "凯", "note": "磁性男声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Nofish", "label": "不吃鱼", "note": "设计师男声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Bella", "label": "萌宝", "note": "小萝莉女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Jennifer", "label": "詹妮弗", "note": "电影质感美语女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Ryan", "label": "甜茶", "note": "节奏感强男声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Katerina", "label": "卡捷琳娜", "note": "御姐女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Eldric Sage", "label": "沧明子", "note": "沉稳睿智老者和声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Mia", "label": "乖小妹", "note": "温顺乖巧女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Mochi", "label": "沙小弥", "note": "聪明伶俐童声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Bellona", "label": "燕铮莺", "note": "洪亮吐字清晰女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Vincent", "label": "田叔", "note": "沙哑烟嗓男声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Bunny", "label": "萌小姬", "note": "萌属性小萝莉", "model": "qwen3-tts-instruct-flash"},
    {"id": "Neil", "label": "阿闻", "note": "专业新闻主持人男声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Elias", "label": "墨讲师", "note": "知识讲解女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Arthur", "label": "徐大爷", "note": "质朴方言男声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Nini", "label": "邻家妹妹", "note": "软糯甜美少女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Seren", "label": "小婉", "note": "温和舒缓女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Pip", "label": "顽屁小孩", "note": "调皮童真男童声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Stella", "label": "少女阿月", "note": "甜美少女声", "model": "qwen3-tts-instruct-flash"},
    {"id": "Jada", "label": "阿珍（上海话）", "note": "风风火火沪上阿姐", "model": "qwen3-tts-instruct-flash"},
    {"id": "Dylan", "label": "晓东（北京话）", "note": "北京胡同少年", "model": "qwen3-tts-instruct-flash"},
    {"id": "Li", "label": "老李（南京话）", "note": "耐心瑜伽老师", "model": "qwen3-tts-instruct-flash"},
    {"id": "Marcus", "label": "秦川（陕西话）", "note": "面宽话短老陕", "model": "qwen3-tts-instruct-flash"},
    {"id": "Roy", "label": "阿杰（闽南语）", "note": "台湾哥仔", "model": "qwen3-tts-instruct-flash"},
    {"id": "Peter", "label": "李彼得（天津话）", "note": "天津相声捧哏", "model": "qwen3-tts-instruct-flash"},
    {"id": "Sunny", "label": "晴儿（四川话）", "note": "甜心川妹子", "model": "qwen3-tts-instruct-flash"},
    {"id": "Eric", "label": "程川（四川话）", "note": "成都男声", "model": "qwen3-tts-instruct-flash"},
]
