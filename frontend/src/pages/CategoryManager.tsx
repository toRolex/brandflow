...
export default function CategoryManager() {
	...
	return (
		<div>
			...
			{suggestions && (
				<div
					className="mb-6 border rounded-xl p-5"
					style={{
					...
					<table className="w-full">
						<thead>
							<tr className="bg-[var(--bg-table-head)] border-b border-[var(--border-default)]">
								<th className="text-left px-5 py-3 text-xs font-medium text-[var(--text-tertiary)]">
									分类名称
								</th>
								<th className="text-left px-5 py-3 text-xs font-medium text-[var(--text-tertiary)]">
									描述
								...
								<th className="text-right px-5 py-3 text-xs font-medium text-[var(--text-tertiary)]">
									操作
								</th>
							</tr>
						</thead>
						<tbody>
							{categories.map((cat, i) => (
								...
								>
									...
									<td className="px-5 py-4 text-sm text-[var(--text-tertiary)] font-mono">
										{cat.vision_prompt}
									</td>
