...
const mockAssets: AssetRecord[] = [
	{
		asset_id: "a1",
		file_path: "/workspace/shared_assets/indexed/longjing/brew/a1.mp4",
		category: "冲泡",
		product: "龙井茶",
		confidence: 0.9,
	...
	{
		asset_id: "a2",
		file_path: "/workspace/shared_assets/indexed/longjing/origin/a2.mp4",
		category: "产地",
		product: "龙井茶",
		confidence: 0.85,
	...
	{
		asset_id: "a3",
		file_path: "/workspace/shared_assets/indexed/puer/brew/a3.mp4",
		category: "冲泡",
		product: "普洱茶",
		confidence: 0.8,
...
describe("SmartAssetLibrary select-all features", () => {
	...
	it("Issue #144: 确认入库时只 index 本次上传文件", async () => {
		...
		await waitFor(() => {
			...
			expect(api.indexAssetsSharedAsync).toHaveBeenCalledWith([
				"uploaded_a.mp4",
				"uploaded_b.mp4",
			]);
		});
