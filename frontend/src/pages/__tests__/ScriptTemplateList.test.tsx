...
const MOCK_TEMPLATES = [
  ...
  },
  {
    ...
    slots: [
      { type: "hook" as const, label: "开场白", required: true, max_length: 60, hint: "" },
      { type: "selling_point" as const, label: "测评点", required: true, max_length: 200, hint: "" },
    ],
    variables: [],
    default_config_override: {},
  },
...
describe("ScriptTemplateList", () => {
  ...
  it("新建按钮链接到编辑器", async () => {
    ...
    expect(newBtn.closest("a")).toHaveAttribute("href", "/system/config/templates/new");
  });
});
