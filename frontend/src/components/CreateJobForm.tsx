	...
	const handleApplyTemplate = async () => {
		...
		try {
			...
			tmpl.slots.forEach((slot) => {
				slotContents[slot.label] =
					templateVariableValues[`slot_${slot.label}`] || "";
			});
				...
				<div className="mb-3 flex flex-wrap items-center gap-4">
					...
					>
						<input
							...
							onChange={(e) =>
								setLanguage(e.target.checked ? "cantonese" : "mandarin")
							}
						/>
						粤语版
					</label>
				...
				<div>
					{isImport && (
						...
						<div className="mb-3">
							...
							{showTemplateSection && (
								<div
									className="border rounded-lg p-4 mb-3 space-y-3"
									style={{
