...
项目当前版本：**0.7.16**（`pyproject.toml` 第 4 行，唯一事实来源）

## 需随发版更新的版本号

| 文件 | 行 | 当前值 | 用途 |
|------|-----|--------|------|
| `pyproject.toml` | 4 | `0.7.16` | ✅ 项目版本（事实来源） |
| `frontend/package.json` | 4 | `0.7.16` | ✅ 前端版本（与 pyproject 同步） |
| `CONTEXT.md` | 132 | `v0.7.16` | ✅ 架构状态版本引用（同步脚本自动更新） |
